...
class BeamerClient: NSObject, NetServiceDelegate, NetServiceBrowserDelegate, GCDAsyncSocketDelegate {
    ...
    func startBroadCasting() {
        ...
        do {
            ...
            self.service = NetService(domain: "local.", type: "_beamer._tcp.", name: UIDevice.current.name, port: Int32(self.socket.localPort))
